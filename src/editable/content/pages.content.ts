...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Businesses and services worth discovering',
      description: 'Find and compare businesses, products, and professional services on convergephp.',
      openGraphTitle: 'Businesses and services worth discovering',
      openGraphDescription: 'Browse useful business listings, services, and company information in one place.',
      keywords: ['business directory', 'business listings', 'local services', 'company discovery'],
    },
    hero: {
      badge: 'Find · Compare · Connect',
      title: ['Great businesses.', 'One useful directory.'],
      description: 'Explore companies, compare services, and find businesses ready to help with what comes next.',
      primaryCta: { label: 'Browse businesses', href: '/listing' },
      secondaryCta: { label: 'Add your business', href: '/create' },
      searchPlaceholder: 'Search businesses and services',
      focusLabel: 'Focus',
    ...
    intro: {
      ...
      title: 'Built for finding and comparing useful businesses.',
      paragraphs: [
        'This directory brings business information, services, locations, and contact details together in one clear discovery experience.',
        'Visitors can compare available businesses and understand what each company provides without moving through disconnected pages.',
        'Whether someone needs a local provider, a specialist service, or a new company to work with, useful listing information stays easy to browse.',
      ],
      sideBadge: 'At a glance',
      sidePoints: [
        'Business-first homepage with strong listing imagery.',
        'Clear company, service, and contact information.',
        'Cleaner browsing designed to make comparison easier.',
        'Fast and readable business discovery.',
      ],
    ...
    cta: {
      ...
      description: 'Move between company profiles, service details, locations, and contact information through one clear directory.',
      primaryCta: { label: 'Browse Businesses', href: '/listing' },
  ...
  create: {
    ...
    hero: {
      ...
      title: 'Create a business listing that gets noticed.',
      description: 'Add clear service details, useful images, location information, and a reliable way for customers to contact you.',
    },
