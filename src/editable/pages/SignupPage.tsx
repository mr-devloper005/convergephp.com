  ...
  return (
    <EditableSiteShell>
      <main className="bg-[var(--slot4-panel-bg)] text-[var(--slot4-page-text)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-stretch overflow-hidden px-4 py-10 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
          <div className="flex flex-col justify-center rounded-t-2xl border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] p-8 shadow-[0_4px_24px_rgba(0,0,0,0.08)] lg:rounded-l-2xl lg:rounded-tr-none sm:p-12">
          ...
          <div className="flex flex-col justify-center rounded-b-2xl bg-[#23252a] p-8 text-white lg:rounded-r-2xl lg:rounded-bl-none lg:p-14">
