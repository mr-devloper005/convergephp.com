...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#202227',
  '--slot4-panel-bg': '#f1f2f4',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#6d7078',
  '--slot4-soft-muted-text': '#999999',
  '--slot4-accent': '#147d92',
  '--slot4-accent-fill': '#147d92',
  '--slot4-accent-soft': '#e2f3f5',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#222429',
  ...
  '--editable-border': '#dedfe3',
  '--editable-nav-bg': '#23252a',
  '--editable-nav-text': '#ffffff',
  '--editable-nav-active': '#8ed7e2',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#ffffff',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#191a1e',
